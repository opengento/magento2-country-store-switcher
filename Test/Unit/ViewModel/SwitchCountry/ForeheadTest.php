...
/**
 * @covers \Opengento\CountryStoreSwitcher\ViewModel\SwitchCountry\Forehead
 */
class ForeheadTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->forehead = new Forehead($this->scopeConfig, $this->countryRepository);
    }
    ...
    public function testGetCountries(string $config, array $countries): void
    {
        $this->scopeConfig->expects($this->once())
            ->method('getValue')
            ->with('country/switcher/forehead', 'website')
            ->willReturn($config);
        ...
        $this->assertSame($countries, $this->forehead->getCountries());
    }
